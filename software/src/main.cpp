...
const unsigned long period = 40UL * 1000UL;  // 40 seconds, cast to fix warning about int overflow
...
const long high_limit = MAX_ADC_COUNTS * 90 / 100;
const long low_limit = MAX_ADC_COUNTS * 10 / 100;
